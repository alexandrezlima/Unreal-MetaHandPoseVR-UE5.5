...
#include "OculusHandPoseRecognition/Public/HandRecognitionFunctionLibrary.h"
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHandRecognitionFunctionLibrary_RecordHandPose_Statics::NewProp_InExecs = { "InExecs", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(HandRecognitionFunctionLibrary_eventRecordHandPose_Parms, InExecs), Z_Construct_UEnum_OculusHandPoseRecognition_ERecordHandPoseEntryType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InExecs_MetaData), NewProp_InExecs_MetaData) }; // 3718464119
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::NewProp_Behavior = { "Behavior", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(HandRecognitionFunctionLibrary_eventWaitForHandGesture_Parms, Behavior), Z_Construct_UEnum_OculusHandPoseRecognition_EGestureConsumptionBehavior, METADATA_PARAMS(0, nullptr) }; // 2449464174
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHandRecognitionFunctionLibrary, nullptr, "WaitForHandGesture", nullptr, nullptr, Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::PropPointers), sizeof(Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::HandRecognitionFunctionLibrary_eventWaitForHandGesture_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C22401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture_Statics::Function_MetaDataParams) };
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UHandRecognitionFunctionLibrary);
UClass* Z_Construct_UClass_UHandRecognitionFunctionLibrary_NoRegister()
{
	return UHandRecognitionFunctionLibrary::StaticClass();
}
struct Z_Construct_UClass_UHandRecognitionFunctionLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHandRecognitionFunctionLibrary_RecordHandPose, "RecordHandPose" }, // 3822233197
		{ &Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandGesture, "WaitForHandGesture" }, // 4123226661
		{ &Z_Construct_UFunction_UHandRecognitionFunctionLibrary_WaitForHandPose, "WaitForHandPose" }, // 3407715923
	};
...
template<> OCULUSHANDPOSERECOGNITION_API UClass* StaticClass<UHandRecognitionFunctionLibrary>()
{
	return UHandRecognitionFunctionLibrary::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EWaitForHandPoseExitType_StaticEnum, TEXT("EWaitForHandPoseExitType"), &Z_Registration_Info_UEnum_EWaitForHandPoseExitType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4028711804U) },
		{ EWaitForHandGestureExitType_StaticEnum, TEXT("EWaitForHandGestureExitType"), &Z_Registration_Info_UEnum_EWaitForHandGestureExitType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2168136382U) },
		{ ERecordHandPoseEntryType_StaticEnum, TEXT("ERecordHandPoseEntryType"), &Z_Registration_Info_UEnum_ERecordHandPoseEntryType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3718464119U) },
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHandRecognitionFunctionLibrary, UHandRecognitionFunctionLibrary::StaticClass, TEXT("UHandRecognitionFunctionLibrary"), &Z_Registration_Info_UClass_UHandRecognitionFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHandRecognitionFunctionLibrary), 1507503685U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_3102240824(TEXT("/Script/OculusHandPoseRecognition"),
	Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandRecognitionFunctionLibrary_h_Statics::EnumInfo));
// End Registration
