...
class UScriptStruct* FHandPose::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HandPose.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHandPose, (UObject*)Z_Construct_UPackage__Script_OculusHandPoseRecognition(), TEXT("HandPose"));
	}
	return Z_Registration_Info_UScriptStruct_HandPose.OuterSingleton;
}
template<> OCULUSHANDPOSERECOGNITION_API UScriptStruct* StaticStruct<FHandPose>()
{
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ RecognizedBone_StaticEnum, TEXT("RecognizedBone"), &Z_Registration_Info_UEnum_RecognizedBone, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 387591522U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHandPose::StaticStruct, Z_Construct_UScriptStruct_FHandPose_Statics::NewStructOps, TEXT("HandPose"), &Z_Registration_Info_UScriptStruct_HandPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHandPose), 1181472142U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_2738629364(TEXT("/Script/OculusHandPoseRecognition"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ep_vr_Plugins_OculusHandTools_Source_OculusHandPoseRecognition_Public_HandPose_h_Statics::EnumInfo));
// End Registration
